INSERT INTO PUBLIC.USERS (Id, USERNAME, PASSWORD, NAME, EMAIL, USER_TYPE, USER_STATE, CREATED_DATE, FAILED_ATTEMPT, CREATED_BY, LAST_MODIFIED_BY, LAST_MODIFIED_DATE, DELETED, VERSION)
VALUES
    (0,'admin', '$2a$10$vEg4sMlDfxIecLLHOGU5h.3kK1wJuZF5a.XGEU2Rd8ZSsbKycfqxO', 'Administrator', 'admin@bookstore.com', 2, 0, '2022-08-02 17:30:00', 0, 'ADMIN', 'ADMIN', '2022-08-02 17:30:00', 0, 0),
    (1,'arman', '$2a$10$vEg4sMlDfxIecLLHOGU5h.3kK1wJuZF5a.XGEU2Rd8ZSsbKycfqxO', 'Arman', 'arman.hassanpoor2000@gmail.com', 2, 0, '2022-08-02 17:30:00', 0, 'ADMIN', 'ADMIN', '2022-08-02 17:30:00', 0, 0);
